...
var song = new Audio("audio/bg.mp3");
song.loop = true;
song.autoplay = true;
document.body.appendChild(song);
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Aug 05, 2021 08:00:00").getTime();
		...
		document.getElementById("seconds").innerHTML = seconds + " <small>second</small> ";

		// If the count down is finished, write some text 
		if (distance < 0) {
		 clearInterval(x);
		 document.getElementById("demo").innerHTML = "Pernikahan sudah dilaksanakan";
		}
		}, 1000);	
